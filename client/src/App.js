...
const AdminDashboard = lazy(() =>
  import("./pages/administrator/dashboard.jsx")
);
...
const StudentProfile = lazy(() =>
  import("./pages/students/studentProfile.jsx")
);
...
const StudentDetail = lazy(() =>
  import("./teacher-service/pages/studentDetail.jsx")
);
...
const ParentFees = lazy(() =>
  import("./parent-portal/pages/fees/parent-fees.jsx")
);
const AcademicHistory = lazy(() =>
  import("./parent-portal/pages/academics/parent-academics.jsx")
);
const ParentEvents = lazy(() =>
  import("./parent-portal/pages/events/parent-events.jsx")
);
const Setting = lazy(() => import("./super-admin/pages/settings/settings.jsx"));
const SuperDashboard = lazy(() =>
  import("./super-admin/pages/dashboard/dasboard.jsx")
);
const ParentPortal = lazy(() =>
  import("./parent-portal/pages/dashboard/dashboard.jsx")
);
const ProfileSuper = lazy(() =>
  import("./super-admin/pages/profile/profiles.jsx")
);
const Schools = lazy(() => import("./super-admin/pages/schools/school.jsx"));
const Subsciptions = lazy(() =>
  import("./super-admin/pages/subscriptions/subscription.jsx")
);
const AddSubsciptions = lazy(() =>

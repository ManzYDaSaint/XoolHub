        ...
        <div className="shadow_container">
            <div className="content">
                ...
                <div className="body">
                    ...
                    <p>Protecting your tickets is our priority. Please confirm your <br></br>account by entering the authrization code sent to <br></br><strong>ManzyN@outlook.com</strong></p>

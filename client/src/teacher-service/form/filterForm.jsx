      ...
      if (res.data.success === true) {
        ...
        if(students.length === 0) {
          ...
          setFilterData(filterData);
            ...
            actions: (
              <>
                <button onClick={() => handleEdit(item.resultid)} className='action_icon'><Icon name='redo' className='action_edit' /></button>
              </>
            ),
            }));
            setFilterData(filterData);
    ...
    <div>
      ...
      <form onSubmit={handleFilter}>
          <div className="multi_step mt-3">
            <h3><span className='m-3'>Step 1:</span> Filter the students</h3>
